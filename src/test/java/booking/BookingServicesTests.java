...
public class BookingServicesTests {
	...
	public void getBookingListByCustomerIdTest() {
		...
		Assert.isTrue(bookingList.size() > 0, "does not match count to expect");
    ...
    public void getBookingByIdTest() {
        ...
        Booking booking = bookingService.getBooking(135);

        log.info(booking.toString());

        Assert.isTrue(booking.getHotel().getId() == 103, "does not match hotel id to expect");
        Assert.isTrue(booking.getRoom().getId() == 222, "does not match room id to expect");
...
//
//        Booking bookingCancel = bookingService.getBooking(136);
